...
execute join(['function! vital#_coquille#Random#import() abort', printf("return map({'_vital_depends': '', 'shuffle': '', 'range': '', 'make_seed': '', 'seed': '', 'bool': '', 'generate_canonical': '', 'next': '', 'sample': '', 'new': '', '_vital_loaded': ''}, \"vital#_coquille#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:save_cpo = &cpo
set cpo&vim

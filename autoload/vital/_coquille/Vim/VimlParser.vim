...
execute join(['function! vital#_coquille#Vim#VimlParser#import() abort', printf("return map({'isalnum': '', 'isalpha': '', 'ExArg': '', 'islower': '', 'isnamec': '', 'iswordc1': '', 'iswhite': '', 'isdigit': '', 'import': '', 'isvarname': '', 'Node': '', 'Err': '', 'isnamec1': '', 'isargname': '', 'isupper': '', 'isxdigit': '', 'iswordc': '', 'isodigit': '', 'isidc': ''}, \"vital#_coquille#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___

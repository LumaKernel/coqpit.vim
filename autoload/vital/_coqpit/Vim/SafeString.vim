...
execute join(['function! vital#_coqpit#Vim#SafeString#import() abort', printf("return map({'string': '', '_vital_loaded': ''}, \"vital#_coqpit#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___

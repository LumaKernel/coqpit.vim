...
execute join(['function! vital#_coqpit#Vim#PowerAssert#import() abort', printf("return map({'_vital_depends': '', 'define': '', 'assert': '', '_vital_loaded': ''}, \"vital#_coqpit#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
"=============================================================================
